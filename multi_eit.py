...
A = 0.01
B = st.sidebar.number_input('Ω_c', value=1.0, min_value=0.0, max_value=10000.0)
C = st.sidebar.number_input('Ω_s', value=1.0, min_value=0.0, max_value=10000.0)
...
E = st.sidebar.number_input('Γ_21', value=1.0, min_value=0.0, max_value=10000.0)
F = st.sidebar.number_input('Γ_31', value=1.0, min_value=0.0, max_value=10000.0)
G = st.sidebar.number_input('Γ_41', value=1.0, min_value=0.0, max_value=10000.0)
